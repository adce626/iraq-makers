    ...
    <>
      <div className="lg:hidden mb-6">
        <button
          ...
          className="w-full flex items-center justify-between px-5 py-3 bg-gray-900 rounded-xl border border-gray-700 text-white"
        >
      ...
      <aside className={`lg:block ${mobileFilterOpen ? 'block' : 'hidden'}`}>
        <div className="bg-gray-900 rounded-2xl border border-gray-800 p-6 sticky top-24">
          ...
          <select
            ...
            className="w-full bg-gray-800 text-white rounded-lg px-4 py-2.5 text-sm border border-gray-700 focus:border-primary focus:outline-none"
          >
            {sortOptions.map((opt) => (
